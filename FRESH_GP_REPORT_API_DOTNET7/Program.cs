using FRESH_GP_REPORT_API_DOTNET7.Services;
...
builder.Services.AddScoped<FreshReportServices>(provider =>
{
    return new FreshReportServices(builder.Configuration.GetConnectionString("OracleConnection"));
});
